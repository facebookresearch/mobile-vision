    ...
    def test_count_strides(self):
        ...
        arch_def_v = {
            ...
            "blocks2": [
                ...
                [("conv_k3", 32, 2, 1)],
                # stage 1
                [("ir_k3", 64, [1, 2], 2, e6), ("ir_k5", 96, -2, 1, e6)],
            ],
        }
        ...
        all_strides1_v = mbuilder.count_strides(unified_arch_v["blocks1"])
        all_strides2_v = mbuilder.count_strides(unified_arch_v["blocks2"])
        self.assertEqual(all_strides1_v, [4, 2])
        self.assertEqual(all_strides2_v, [1, 2])
