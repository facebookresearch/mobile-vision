...
_PRIMITIVES = {
    ...
    "conv_k1": lambda in_channels, out_channels, stride, **kwargs: bb.ConvBNRelu(
        ...
        out_channels,
        **hp.merge(
            conv_args={"stride": stride, "kernel_size": 1, "padding": 0}, kwargs=kwargs
        )
    ),
    "conv_k3": lambda in_channels, out_channels, stride, **kwargs: bb.ConvBNRelu(
        ...
        out_channels,
        **hp.merge(
            conv_args={"stride": stride, "kernel_size": 3, "padding": 1}, kwargs=kwargs
        )
    ),
    "conv_k5": lambda in_channels, out_channels, stride, **kwargs: bb.ConvBNRelu(
        ...
        out_channels,
        **hp.merge(
            conv_args={"stride": stride, "kernel_size": 5, "padding": 2}, kwargs=kwargs
        )
    ),
