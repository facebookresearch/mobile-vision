...
sys.path.append("mobile-vision/mobile_cv/")
import mobile_cv.common.fb.flu.aibench_utils as au
import mobile_cv.common.fb.flu.fblearner_launch_utils as flu
import mobile_cv.common.fb.flu.launch_helper as lh
...
MODELS = [
    ...
    # ("fbnet_v2", "RegNetY_600M", 224, "jit"),
    # ("fbnet_v2", "eff_v2_s", 384, "jit"),
    # ("fbnet_v2", "eff_v2_m", 480, "jit"),
    # ("fbnet_v2", "eff_v2_l", 480, "jit"),
    # ("fbnet_v2", "eff_v2_xl", 512, "jit"),
    ("fbnet_v2", "eff_v2_b0", 224, "jit"),
    ("fbnet_v2", "eff_v2_b1", 240, "jit"),
    ("fbnet_v2", "eff_v2_b2", 260, "jit"),
    ("fbnet_v2", "eff_v2_b3", 300, "jit"),
...
MODEL_INFOS = [
    {
        "name": f"{builder}{'_' + x if x is not None else ''}{'_batch' + '%02d'%bench_batch}",
        "builder": builder,
        "arch": x,
        "inputs": [[bench_batch, 3, res, res]],
